...
model = SelfPlayModel("SavedModels/actor-critic-CHECKERS-month-6-day-9-ep-154647-50%.h5")
with open("SavedModels/SavedLogs/log-CHECKERS-month-6-day-9-ep-154647-50.0%.pkl", "rb") as logger_file:
